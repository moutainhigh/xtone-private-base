    ...
    function Piechart(paper, cx, cy, r, values, opts) {
        ...
        var legend = function (labels, otherslabel, mark, dir) {
            ...
            for (var i = 0; i < len; i++) {
                ...
                chart.labels[i].push(txt = paper.text(x + 15, h, labels[j] || values[j]).attr(chartinst.txtattr).attr({ fill: opts.legendcolor || "#000", "text-anchor": "start"}));
            ...
            var bb = chart.labels.getBBox(),
                tr = {
                    east: [0, -bb.height / 2],
                    west: [-bb.width -  2 * r - 30, -r -bb.height + 20],
                    north: [-r - bb.width / 1.5, -r - bb.height - 20],
