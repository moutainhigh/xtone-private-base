...
<script type="text/javascript" src="./source/js/busi/delete.js"></script>
<style type="text/css">
	*{
		font-size:14px;
	}
...
<div class="goods" id="datainfo">
	<div class="section_head">
		<span style="display:block;float:left;font-size:20px;color: #ffffff;font-weight: bold;">清除推送记录</span>
	</div>
		...
		<table>
				<tr>
					<td valign="bottom" colspan="5" align="right">
						<input type="button" value="清除推送记录" onclick="doDelete();" style="padding:0.4em 1em;margin-right:0.4em;font-size:14px;"/>
					</td>
				</tr>
