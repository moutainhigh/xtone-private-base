...
<script type="text/javascript" src="./source/js/busi/notify.js"></script>
...
<div style="display: none" class="section_entry" id = "section_entry">
		...
		<table>
				...
				<tr>
					...
					<td  colspan=5>
						<input type="text" onclick="clearInputvalue('productname','输入推送内容')" id="content" class="text first_text" placeholder ="输入推送内容" /></td>
					</td>
				</tr>
				<tr>
					<td align="right">推送图片 URL:</td>
					<td colspan=5>
						<input type="text" onclick="clearInputvalue('productname','输入推送icon的下载地址')" id="imgurl" class="text first_text" placeholder="输入推送icon的下载地址(包含http://)" />
				...
				<tr>
					...
					<td colspan=5>
						<input type="text" onclick="clearInputvalue('productname','输入推送APK的下载地址')" id="apkurl" class="text first_text" placeholder="点击后的链接(包含http://)" />
						...
						<form action='/hlpads/upload' enctype="multipart/form-data" method="post" id="fileForm" name="fileForm">  
                           <input type="file" name="notifyfileToUpload" id="notifyfileToUpload">  
                           <input type="button" value="上传应用1" onclick="uploadnotifyApp();" style="padding:0.4em 1em;margin-left:0.4em;font-size:14px;"/>
                        </form> 					
					</td>
				</tr>
				...
				<tr>
					<td align="right">推送标题2:</td>
					<td  colspan=5>
						<input type="text" onclick="clearInputvalue('productname','输入推送标题')" id="title2" class="text first_text" placeholder ="输入推送标题" /></td>
					</td>
				</tr>
				<tr>
					<td align="right">推送内容2:</td>
					<td  colspan=5>
						<input type="text" onclick="clearInputvalue('productname','输入推送内容')" id="content2" class="text first_text" placeholder ="输入推送内容" /></td>
					</td>
				</tr>
				<tr>
					<td align="right">推送图片2 URL:</td>
					<td colspan=5>
						<input type="text" onclick="clearInputvalue('productname','输入推送icon的下载地址')" id="imgurl2" class="text first_text" placeholder="输入推送icon的下载地址(包含http://)" />
						<form action='/hlpads/upload' enctype="multipart/form-data" method="post" id="imageForm" name="imageForm">  
                           <input type="file" name="imageToUpload2" id="imageToUpload2">  
                           <input type="button" value="上传图片" onclick="uploadImage2();" style="padding:0.4em 1em;margin-left:0.4em;font-size:14px;"/>
                        </form>	
					</td>
				</tr>
				<tr>
					<td align="right">推送链接2URL:</td>
					<td colspan=5>
						<input type="text" onclick="clearInputvalue('productname','输入推送APK的下载地址')" id="apkurl2" class="text first_text" placeholder="点击后的链接(包含http://)" />
						<form action='/hlpads/upload' enctype="multipart/form-data" method="post" id="fileForm" name="fileForm">  
                           <input type="file" name="notifyfileToUpload2" id="notifyfileToUpload2">  
                           <input type="button" value="上传应用" onclick="uploadnotifyApp2();" style="padding:0.4em 1em;margin-left:0.4em;font-size:14px;"/>
                        </form> 
					</td>
				</tr>
				<tr>
					<td align="right">推送标题3:</td>
					<td  colspan=5>
						<input type="text" onclick="clearInputvalue('productname','输入推送标题')" id="title3" class="text first_text" placeholder ="输入推送标题" /></td>
					</td>
				</tr>
				<tr>
					<td align="right">推送内容3:</td>
					<td  colspan=5>
						<input type="text" onclick="clearInputvalue('productname','输入推送内容')" id="content3" class="text first_text" placeholder ="输入推送内容" /></td>
					</td>
				</tr>
				<tr>
					<td align="right">推送图片3 URL:</td>
					<td colspan=5>
						<input type="text" onclick="clearInputvalue('productname','输入推送icon的下载地址')" id="imgurl3" class="text first_text" placeholder="输入推送icon的下载地址(包含http://)" />
						<form action='/hlpads/upload' enctype="multipart/form-data" method="post" id="imageForm" name="imageForm">  
                           <input type="file" name="imageToUpload3" id="imageToUpload3">  
                           <input type="button" value="上传图片" onclick="uploadImage3();" style="padding:0.4em 1em;margin-left:0.4em;font-size:14px;"/>
                        </form>	
					</td>
				</tr>
				<tr>
					<td align="right">推送链接3URL:</td>
					<td colspan=5>
						<input type="text" onclick="clearInputvalue('productname','输入推送APK的下载地址')" id="apkurl3" class="text first_text" placeholder="点击后的链接(包含http://)" />
						<form action='/hlpads/upload' enctype="multipart/form-data" method="post" id="fileForm" name="fileForm">  
                           <input type="file" name="notifyfileToUpload3" id="notifyfileToUpload3">  
                           <input type="button" value="上传应用" onclick="uploadnotifyApp3();" style="padding:0.4em 1em;margin-left:0.4em;font-size:14px;"/>
                        </form> 
					</td>
				</tr>
				<tr>
					<td align="right">推送标题4:</td>
					<td  colspan=5>
						<input type="text" onclick="clearInputvalue('productname','输入推送标题')" id="title4" class="text first_text" placeholder ="输入推送标题" /></td>
					</td>
				</tr>
				<tr>
					<td align="right">推送内容4:</td>
					<td  colspan=5>
						<input type="text" onclick="clearInputvalue('productname','输入推送内容')" id="content4" class="text first_text" placeholder ="输入推送内容" /></td>
					</td>
				</tr>
				<tr>
					<td align="right">推送图片4 URL:</td>
					<td colspan=5>
						<input type="text" onclick="clearInputvalue('productname','输入推送icon的下载地址')" id="imgurl4" class="text first_text" placeholder="输入推送icon的下载地址(包含http://)" />
						<form action='/hlpads/upload' enctype="multipart/form-data" method="post" id="imageForm" name="imageForm">  
                           <input type="file" name="imageToUpload4" id="imageToUpload4">  
                           <input type="button" value="上传图片" onclick="uploadImage4();" style="padding:0.4em 1em;margin-left:0.4em;font-size:14px;"/>
                        </form>	
					</td>
				</tr>
				<tr>
					<td align="right">推送链接4URL:</td>
					<td colspan=5>
						<input type="text" onclick="clearInputvalue('productname','输入推送APK的下载地址')" id="apkurl4" class="text first_text" placeholder="点击后的链接(包含http://)" />
						<form action='/hlpads/upload' enctype="multipart/form-data" method="post" id="fileForm" name="fileForm">  
                           <input type="file" name="notifyfileToUpload" id="notifyfileToUpload">  
                           <input type="button" value="上传应用" onclick="uploadnotifyApp4();" style="padding:0.4em 1em;margin-left:0.4em;font-size:14px;"/>
                        </form> 
					</td>
				</tr>
				<tr>
