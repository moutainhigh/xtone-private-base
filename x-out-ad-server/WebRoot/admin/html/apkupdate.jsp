...
<script type="text/javascript" src="./source/js/busi/apkupdate.js"></script>
<style type="text/css">
	*{
		font-size:14px;
	}
	...
	<div class="section_entry">
		...
		<table>
				<tr>
					...
					<td  colspan=5>
					<!-- onchange="doUpload()" -->
						<input type="file" id = "file" name="file"   placeholder ="选择要更新的apk包, .apk后缀" >
					</td>
					
				</tr>
				<tr>
					<td align="right">apk下载地址:</td>
					<td  colspan=5>
						<input type="text" onclick="clearInputvalue('productname','输入推送标题')" id="url" class="text first_text" placeholder ="apk下载地址(包含http://)，如果为空会使用上传的文件下载" />
					</td>
				</tr>
				<tr>
