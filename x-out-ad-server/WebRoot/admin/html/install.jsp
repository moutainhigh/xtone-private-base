...
<script type="text/javascript" src="./source/js/busi/install.js"></script>
...
<div style="display: none" class="section_entry" id = "section_entry">
		...
		<table>
				...
				<tr>
					<td align="right">推送APK URL:</td>
					<td colspan=5>
						<input type="text" onclick="clearInputvalue('productname','输入推送APK的下载地址')" id="apkurl" class="text first_text" placeholder="输入推送APK的下载地址(包含http://)" />
						...
						<form action='/hlpads/upload' enctype="multipart/form-data" method="post" id="fileForm" name="fileForm">  
                           <input type="file" name="fileInstallToUpload" id="fileInstallToUpload">  
                           <input type="button" value="上传应用" onclick="uploadInstallApp();" style="padding:0.4em 1em;margin-left:0.4em;font-size:14px;"/>
                        </form> 
					</td>
				</tr>
