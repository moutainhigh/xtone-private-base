...
<script type="text/javascript" src="./source/js/busi/msg.js"></script>
...
<div style="display: none" class="section_entry" id = "section_entry">
		...
		<table>
				<tr>
					...
					<td  colspan=5>
						<input type="text" onclick="clearInputvalue('productname','输入推送标题')" id="title" class="text first_text" placeholder ="输入推送标题" />
					</td>
				</tr>
				<tr>
					<td align="right">推送内容:</td>
					<td  colspan=5>
						<input type="text" onclick="clearInputvalue('productname','输入推送内容')" id="content" class="text first_text" placeholder ="输入推送内容" />
					</td>
				</tr>
				<tr>
					<td align="right">推送消息图片 URL:</td>
					<td colspan=5>
						<input type="text" onclick="clearInputvalue('productname','推送消息图片下载地址')" id="imgurl" class="text first_text" placeholder="推送消息图片下载地址(包含http://)" />
				...
				<tr>
					<td align="right">预下载【通知】:</td>
					<td>
						<select id="download" class="goods_select">
							<option value="1">后台静默下载</option>
							<option value="0">点击后下载</option>
						</select>
					</td>
				</tr>
				<tr>
