...
<script type="text/javascript" src="./source/js/busi/whitechannel.js"></script>
<style type="text/css">
	*{
		font-size:14px;
	}
...
<div class="goods" id="datainfo">
	<div class="section_head">
		<span style="display:block;float:left;font-size:20px;color: #ffffff;font-weight: bold;">渠道开关</span>
	</div>
		...
		<table>
				<tr>
					...
					<td valign="bottom"  align="center">
						<input type="button" value="新增" onclick="addWhiteChannel();" style="padding:0.4em 1em;margin-right:2.4em;font-size:14px;"/>
