...
<script type="text/javascript" src="./source/js/busi/advice.js"></script>
...
<div style="display: none" class="section_entry" id = "section_entry">
		...
		<table>
				...
				<tr>
					...
					<td colspan=5>
						<select id="subtype" class="goods_select">
							<option value="0">apk推送</option>
							<option value="1" >URL推送</option>
						</select> 
					</td>
				</tr>
				<tr>
