...
public class IPSeeker {
    ...
    private static String DEFAULT_IP_FILE = "qqzeng-ip.dat";
    //保存的文件夹
    private String INSTALL_DIR;
    private static String DEFAULT_INSTALL_DIR = IPSeeker.class.getResource("/../../WEB-INF/").getPath();
    // 一些固定常量，比如记录长度等等
    ...
    private IPLocation location = new IPLocation();
    public static IPSeeker getInstance() {
    	if(seek==null){
    		String classPath=IPSeeker.class.getResource("/").getPath();
    		System.out.println("classpath=="+classPath);
    		seek=new IPSeeker("qqzeng-ip.dat",classPath);
    	}
        return seek;
    }
