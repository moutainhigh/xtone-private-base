...
public class WnsApkInfo
{
     ...
     * 暗指的特性。
     */
    private List<WnsApkFeature> apkFeatures;
    ...
    public WnsApkInfo()
    {
        ...
        this.apkFeatures = new ArrayList<WnsApkFeature>();
    ...
    public void addToImpliedFeatures(WnsApkFeature impliedFeature)
    {
        this.apkFeatures.add(impliedFeature);
    }
     ...
     * @return
     */
    public List<WnsApkFeature> getImpliedFeatures()
    {
        return apkFeatures;
    }

    public void setImpliedFeatures(List<WnsApkFeature> impliedFeatures)
    {
        this.apkFeatures = impliedFeatures;
    }
    ...
    {
        return "NgsteamApkInfo [versionCode=" + versionCode + ",\n versionName="
