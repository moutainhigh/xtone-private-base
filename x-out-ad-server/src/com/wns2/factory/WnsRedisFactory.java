...
public class WnsRedisFactory {
  ...
  private static Jedis getInstance() {
    if (pool == null) {
      redisConnFactory = (JedisConnectionFactory) WnsSpringHelper.getBean("redisConnectionFactory");
  ...
  public static void setRedisConnFactory(JedisConnectionFactory redisConnFactory) {
