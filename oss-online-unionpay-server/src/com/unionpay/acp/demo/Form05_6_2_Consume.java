...
public class Form05_6_2_Consume extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		contentData.put("merId", "898440379930027");   		 				//商户号码，请改成自己申请的商户号或者open上注册得来的777商户号测试
...
//		contentData.put("backUrl","http://thirdpay.youkala.com:29141/UnionpayCountServlet?xx_notifyData="+xx_notifyData);
		contentData.put("backUrl","thirdpay.oss.vanggame.com:29141/UnionpayCountServlet?xx_notifyData="+xx_notifyData);
		//pc
