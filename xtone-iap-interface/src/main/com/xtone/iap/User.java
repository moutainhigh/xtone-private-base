...
public class User {
	...
	public String toString() {
		return "User [original_purchase_date_pst=" + original_purchase_date_pst + ", purchase_date_ms="
				+ purchase_date_ms + ", unique_identifier=" + unique_identifier + ", original_transaction_id="
				+ original_transaction_id + ", bvrs=" + bvrs + ", transaction_id=" + transaction_id + ", quantity="
				+ quantity + ", unique_vendor_identifier=" + unique_vendor_identifier + ", item_id=" + item_id
				+ ", product_id=" + product_id + ", purchase_date=" + purchase_date + ", original_purchase_date="
				+ original_purchase_date + ", purchase_date_pst=" + purchase_date_pst + ", bid=" + bid
