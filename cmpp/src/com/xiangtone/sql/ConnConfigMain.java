...
public abstract class ConnConfigMain
{
    ...
    public static DataSource setupDataSource()
    {
        ...
        ds.setUrl(ConfigManager.getConfigData("w_dbip_public"));
        ds.setUsername(ConfigManager.getConfigData("w_dbuser_public"));
        ds.setPassword(ConfigManager.getConfigData("w_dbpwd_public"));
        ds.setInitialSize(4);
        ds.setMaxActive(32);
        ds.setMaxIdle(8);
        ds.setMinIdle(4);
