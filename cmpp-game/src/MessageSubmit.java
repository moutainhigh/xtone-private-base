...
public class MessageSubmit
{
    ...
    public mysqldb db;
     ...
     public  void set_destCpn(String str)  { this.destCpn = str;}
     public  void set_feeCpn(String str)   { this.feeCpn = str;}
     public  void set_cpnType(int type) { this.cpntype = type;}//add at 061123
     public  void set_content(String str)  { this.content = str;}
     public  void set_serverID(String str) { this.serverID = str;}
     public  void set_vcpID(String str)    { this.vcpID = str;}
     public  void set_provID(String str)   { this.provID = str;}
     
     public  void set_spCode(String str)    { this.spCode = str;}
     public  void set_feeType(String str)   { this.feeType = str;}
     public  void set_feeCode(String str)   { this.feeCode = str;}
     public  void set_mediaType(String str) { this.mediaType = str;}
     public  void set_delivery(String str)  { this.delivery = str;}
     public  void set_linkid(String str){this.linkid = str;}
     public  void set_gameCode(String str)  { this.gameCode = str;}
     public  void set_sendTime(String str)  { this.sendTime = str;}
     public  void set_msgId(String msgId)   { this.msgId = msgId;}
    ...
    public void send_result_to_smsPlatform()
    {
    	...
    	{         sub = new sm_submit();
	    	...
	    	String sms_serverip = (String)ConfigManager.getInstance().getConfigItem("sms_serverip","xiangtone_serverip not found!");
	    	String sms_serverport=(String)ConfigManager.getInstance().getConfigItem("sms_serverport","xiangtone_serverport not found!");
