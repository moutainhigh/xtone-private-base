...
public class XtMoSender extends MoSender{
	String company = "";
	String compUrl = "";
	String sendStat = "";
	...
	public XtMoSender(String company){
	...
	public void getCompanyUrl(){
		...
		System.out.println("xt url is:" + this.compUrl);
	}
	//public void sendMo(){
	public void run(){
		while(true){
				try{
					...
					System.out.println("xt exception");
					e.printStackTrace();
				}
				...
				moCounter.mydb.dbclose();
				try{
					System.out.println("Xt start to rest......");
	...
	private void writeLog(String logStr){
		...
		PropertyConfigurator.configure("xtlog4j.properties"); 
		//logStr = this.compUrl + "\n" + logStr;
