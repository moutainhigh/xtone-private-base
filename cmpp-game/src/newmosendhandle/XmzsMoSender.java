...
public class XmzsMoSender extends MoSender{
	String company = "";
	String compUrl = "";
	String sendStat = "";
	...
	public XmzsMoSender(String company){
	...
	public void getCompanyUrl(){
		...
		System.out.println("xmzs url is:" + this.compUrl);
	}
	//public void sendMo(){
	public void run(){
		while(true){
				try{
					...
					System.out.println("xmzs exception");
					//e.printStackTrace();
					try{
						System.out.println("xmzs exception");
						e.printStackTrace();
				...
				///////////////////////
				if(0 < this.mosList.size() && this.mosList.size()< 3 && this.sendSecond < 2){
				...
				moCounter.mydb.dbclose();
				try{
					System.out.println("Xmzs start to rest......");
	...
	private void writeLog(String logStr){
		...
		PropertyConfigurator.configure("xmzslog4j.properties"); 
		//logStr = this.compUrl + "\n" + logStr;
