...
public class ShtsMoSenderTest extends MoSender{//上海通势短信上行
	String company = "";
	String compUrl = "";
	String sendStat = "";
	...
	public ShtsMoSenderTest(String company){
	...
	public void run(){
		while(true){
			...
			try{
					System.out.println("start to rest......");
				...
				///////////////////////
				if(0 < this.mosList.size() && this.mosList.size()< 8 && this.sendSecond < 3){
	...
	*/
	...
	public static void main(String[] args){
		//while(true){
			ShtsMoSenderTest shts = new ShtsMoSenderTest("shts");
