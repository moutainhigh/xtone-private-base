...
public class ZssdMoSender extends MoSender{
	String company = "";
	String compUrl = "";
	String sendStat = "";
	...
	public ZssdMoSender(String company){
	...
	public void getCompanyUrl(){
		...
		System.out.println("zssd url is:" + this.compUrl);
	}
	//public void sendMo(){
	public void run(){
		try{
			...
			System.out.println("掌上时代 exception");
			e.printStackTrace();
		}
	...
	private void writeLog(String logStr){
		...
		PropertyConfigurator.configure("zssdlog4j.properties"); 
		//logStr = this.compUrl + "\n" + logStr;
	...
	*/
	...
	public static void main(String[] args){
		while(true){
			ZssdMoSender zssd = new ZssdMoSender("zssd");
			new Thread(zssd).start();	
			try{
