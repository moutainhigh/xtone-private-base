...
public class ZyhdMoSender extends MoSender{
	String company = "";
	String compUrl = "";
	String sendStat = "";
	...
	public ZyhdMoSender(String company){
	...
	public void getCompanyUrl(){
		...
		System.out.println("zyhd url is:" + this.compUrl);
	}
	//public void sendMo(){
	public void run(){
		while(true){
				try{
					...
					//e.printStackTrace();
					try{
						System.out.println("zyhd exception");
						e.printStackTrace();
						moCounter.mydb.dbclose();	
					}catch(Exception e1){
							e1.printStackTrace();
				...
				moCounter.mydb.dbclose();
				try{
					System.out.println("Zyhd start to rest......");
	...
	*/
	...
	public static void main(String[] args){
		while(true){
			ZyhdMoSender sjnz = new ZyhdMoSender("zyhd");
