...
public class SzcshdMoSender extends MoSender{//上海通势短信上行
	String company = "";
	String compUrl = "";
	String sendStat = "";
	...
	public SzcshdMoSender(String company){
	...
	public void run(){
		while(true){
				...
				*/
				...
				moCounter.mydb.dbclose();
				try{
					System.out.println("szcshd start to rest......");
	...
	*/
	...
	public static void main(String[] args){
		//while(true){
			SzcshdMoSender shts = new SzcshdMoSender("szcshd");
