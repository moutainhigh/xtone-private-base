...
public class SjnzMoSender extends MoSender{
	String company = "";
	String compUrl = "";
	String sendStat = "";
	...
	public SjnzMoSender(String company){
	...
	public void getCompanyUrl(){
		...
		System.out.println("sjnz url is:" + this.compUrl);
	}
	//public void sendMo(){
	public void run(){
		while(true){
				...
				moCounter.mydb.dbclose();
				try{
					System.out.println("Sjnz start to rest......");
