...
public class mysqldb
{
	...
	public mysqldb()
	{
		...
		String xiangtone_dbip   = (String)ConfigManager.getInstance().getConfigItem("xiangtone_dbip","xiangtone_dbip not found!");
	    String xiangtone_dbport = (String)ConfigManager.getInstance().getConfigItem("xiangtone_dbport","xiangtone_dbport not found!");
		String xiangtone_dbname = (String)ConfigManager.getInstance().getConfigItem("xiangtone_dbname","xiangtone_dbname not found!");
		String xiangtone_dbuser = (String)ConfigManager.getInstance().getConfigItem("xiangtone_dbuser","xiangtone_dbuser not found!");
		String xiangtone_dbpwd  = (String)ConfigManager.getInstance().getConfigItem("xiangtone_dbpwd","xiangtone_dbpwd not found!");
