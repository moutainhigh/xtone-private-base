...
public class CompanysMtsCountHandle implements Runnable{
	...
	public static void main(String[] args){
		CompanysMtsCountHandle mtsCountHandle = new CompanysMtsCountHandle();
		new Thread(mtsCountHandle).start();
	}
}
