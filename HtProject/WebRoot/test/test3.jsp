...
<%@page import="com.system.util.model.Player"%>
<%@page import="java.util.List"%>

<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
	String type = StringUtil.getString(request.getParameter("type"), "NEW_ACCOUNT");
	...
	for(Product model : list2){
		str = result.sendGet("http://gaopen.talkingdata.net/game/player/list", 
				"token=3d5663eacbf64808ae89cd7a5077293f&productId="+model.getProductId()+"&"+
				"startTime="+startDate+"&endTime="+endDate+"&sampleType="+type);
		List<Player> templist = result.gsonToPlayer(str);
		for(Player partner : templist){
			list.add(partner);
		}
		Thread.sleep(5000);
	}
    ...
    <div class="main_content">
		<div class="content" >
			<dl>
				...
				<form action="test3.jsp"  method="post" id="formid">
				<dl>
						...
						<dd class="dd01_me">样本类型</dd>
					<dd class="dd04_me">
						<select name="type" id="type" style="width: 150px;" title="选择SP" >
							<option value="NEW_ACCOUNT">请选择样本类型</option>
							<option value="NEW_ACCOUNT">新增</option>	
							<option value="ACTIVE_ACCOUNT">活跃</option>
							<option value="PAID_ACCOUNT">付费</option>
						</select>
					</dd>
