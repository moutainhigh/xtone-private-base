...
void Config::addUid(std::string uid)
{
  CCUserDefault* ud = CCUserDefault::sharedUserDefault();
  ud->setStringForKey(CONFIG_KEY_UID,uid);
}
std::string Config::getUid()
{
	 CCUserDefault* ud = CCUserDefault::sharedUserDefault();
	 std::string uid = ud->getStringForKey(CONFIG_KEY_UID);
...
/*
int Config::cherryNum()
{
	CCUserDefault* ud = CCUserDefault::sharedUserDefault();
	return m_savedCherryNum = ud->getIntegerForKey(CONFIG_KEY_CHERRYNUM);
}
*/
...
int  Config::getCherry()
{
	CCUserDefault* ud = CCUserDefault::sharedUserDefault();
	return ud->getIntegerForKey(CONFIG_KEY_CHERRYNUM,0);
}
