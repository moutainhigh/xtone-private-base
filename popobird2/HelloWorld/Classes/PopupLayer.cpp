...
PopupLayer::~PopupLayer()
{
	CCNotificationCenter::sharedNotificationCenter()->removeObserver(this, MSG_CALLJNI_BACK_ID);
}
...
bool PopupLayer::init()
{
	...
	CCNotificationCenter::sharedNotificationCenter()->addObserver(this, 
		callfuncO_selector(PopupLayer::notifyHandle), MSG_CALLJNI_BACK_ID, NULL);
...
void PopupLayer::notifyHandle(CCObject* obj)
{
	...
	case TOUCH_EVENT_ENDED:
		{
			...
			{
				//支付
			    AppuSDKInterfaceHelper::instance()->pay(4);
				//CCNotificationCenter::sharedNotificationCenter()->postNotification(
				//	MSG_BUTTON_PRESS_ID, (CCObject *)(CCInteger::create(MSG_ID_POPUPLAYER_GAMEPLAYING_BUTTON_PRESS)));
				//back();
			}
