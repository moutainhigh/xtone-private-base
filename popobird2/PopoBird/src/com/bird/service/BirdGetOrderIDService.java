 ...
 *
 */
@WebServlet("/BirdGetOrderIDService")
public class BirdGetOrderIDService extends HttpServlet{
	static private final Logger LOG = Logger.getLogger(BirdGetOrderIDService.class);
	/**
     * 
     * 外网http://popobird.n8wan.com:29141/BirdGetOrderIDService
     * 
     * @see HttpServlet#HttpServlet()
     */
    public BirdGetOrderIDService() {
        super();
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws UnsupportedEncodingException  {
		...
		try {
	        ...
	        String url = "http://nine.n8wan.com/pay/getOrderID?"+request.getQueryString();
