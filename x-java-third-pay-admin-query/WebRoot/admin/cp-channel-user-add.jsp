...
<script language="JavaScript">
	function commin(){
		...
		var relchannel = $("#relchannel").val().trim();
		...
		if(isNullOrEmpty(relchannel)||relchannel.length>8){
			alert("发布渠道不能为空或者长度不能超过8位");
			return;
		}
		updateAjax();
	}
	...
	<div style="text-align: center; margin-top: 200px">
		...
		<form id="form1" name="form1">
			...
			<span>发布渠道： </span><input type="text"
				name="relchannel" id="relchannel" value="" class="input1"><br></br>
			<span>扣量起始金额： </span><input type="text"
				name="rbamoumt" id="rbamoumt" value="" class="input1"><br></br>
			<span>扣量比例： </span><input type="text"
				name="redscale" id="redscale" value="" class="input1"><br></br>
				<input
				class="btn1" type="button"
				value="确认增加" onclick="commin()"> <input
				class="btn1" type="button"
				value="取消增加" onclick="window.location.href='cp-channel-users.jsp'">
