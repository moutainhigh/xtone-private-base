...
<div id="wrapper">
     <!-- Navigation -->
        ...
        <a style="color: #fff !important;background: transparent;min-width: 1.5em;margin-left:0px" >CP管理</a>
	   ...
	   <div class="xs">
  	 <h3>CP 管理</h3>
  	 <a style="color: #333 !important;border: 1px solid #CACACA;background: transparent linear-gradient(to bottom, #FFF 0%, #DCDCDC 100%) repeat scroll 0% 0%;box-sizing: border-box;display: inline-block;min-width: 1.5em;padding: 0.5em 1em;margin-left: 2px;text-align: center;text-decoration: none !important;cursor: pointer;" href="cp-user-add.jsp">添加CP用户</a>
	...
	<table id="table_id" class="display">
		...
		User user = (User) session.getAttribute("user");
				...
				try {
					...
					String sql = "SELECT id,username,pwd,email,isAvail,isAdmin,lastLogin,ADDTIME,cpid "+
			...
			<tr>
				...
				<td><%=cpId %></td>
				<td> 
				<a href="cp-user-update.jsp?id=<%=id%>">编辑</a>&emsp;
			</tr>
				<%
					}
				}catch (Exception e) {
