...
public class StoreNetNovelListFragment extends BaseFragment {
	...
	private void initData() {
		...
		new BackTask() {
			...
			public String doInThread() {
				// TODO Auto-generated method stub
				if (listBooks == null) {
					listBooks = ShuPengApi.getNetNovel(cId, pIndex, pSize);
				}
				if (listBooks == null) {
					try {
						Thread.sleep(1500);
			...
			public void onRefresh() {
				...
				new BackTask() {
					...
					public String doInThread() {
						// TODO Auto-generated method stub
						pIndex = 1;
						listTmp = ShuPengApi.getNetNovel(cId, pIndex, pSize);
						if (listTmp == null) {
							try {
								Thread.sleep(2000);
							} catch (InterruptedException e) {
