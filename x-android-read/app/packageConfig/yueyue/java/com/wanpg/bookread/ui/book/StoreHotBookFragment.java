...
public class StoreHotBookFragment extends BaseFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if(!resetView(v_main)){
			...
			((TextView) v_main.findViewById(R.id.tv_title)).setText("畅销书");
	...
	private void initData() {
		...
		new BackTask() {
			...
			public String doInThread() {
				// TODO Auto-generated method stub
				if (listBooks == null) {
					listBooks = ShuPengApi.getHotBooks(pIndex, pSize);
				}
				if (listBooks == null) {
					try {
						Thread.sleep(1500);
			...
			public void onRefresh() {
				...
				new BackTask() {
					...
					public String doInThread() {
						// TODO Auto-generated method stub
						pIndex = 1;
						listTmp = ShuPengApi.getHotBooks(pIndex, pSize);
						if (listTmp == null) {
							try {
								Thread.sleep(2000);
							} catch (InterruptedException e) {
