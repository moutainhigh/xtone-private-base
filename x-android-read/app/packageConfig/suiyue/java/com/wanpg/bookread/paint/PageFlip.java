...
public class PageFlip extends PageView {
    ...
    private boolean isChangeNoTouch = false;
	
    public PageFlip(Context context, AttributeSet attrs, int defStyleAttr) {
...
//			}
    ...
    public void calNextXY() {
    	// TODO Auto-generated method stub
        mTouch.x = mWidth / 2 + 100;
        mTouch.y = mHeight / 3;
        calDownXY(mTouch.x, mTouch.y);
    }
