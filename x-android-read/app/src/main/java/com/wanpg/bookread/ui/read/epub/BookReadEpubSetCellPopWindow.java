...
public class BookReadEpubSetCellPopWindow {
    ...
    private BookReadEpubSetPopWindow setPopWindow;

    public BookReadEpubSetCellPopWindow(BookReadEpubActivity activity) {
        // TODO Auto-generated constructor stub
        this.activity = activity;
    }

    public void openPopWindow(View parent, int which, BookReadEpubSetPopWindow setPopWindow) {
        this.setPopWindow = setPopWindow;
        closePopWindow();
        ...
        pwBottomSetCell = new PopupWindow(view, LayoutParams.FILL_PARENT, LayoutParams.WRAP_CONTENT, true);
    ...
    private class MyThemeChangeClickListener implements OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (activity.isMoonOpen()) {
                setPopWindow.ib_set_moonmode.setImageResource(R.drawable.bookread_bottombar_moon);
            }
