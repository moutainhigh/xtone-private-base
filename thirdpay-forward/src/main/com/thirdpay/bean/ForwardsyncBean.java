...
public class ForwardsyncBean {
	...
	// public ForwardsyncBean(int status, String orderId, String sync_status,
	// String next_time, String sendCount,
	// String notify_url, String successCoditions, String appkey, String
	// id_type) {
	// super();
	// this.status = status;
	// this.orderId = orderId;
	...
	// // DbKey 选择使用的数据库
	// con =
	// ConnectionServicethirdpayCount.getInstance().getConnectionForLocal(); //
	// DbKey选择使用config.properties
	// ps = con.prepareStatement(
	// "insert into `log_async_generals`
	// (id,logId,para01,para02,para03,para04,para05,para06,para07,para08) values
	// (?,?,?,?,?,?,?,?,?,?)");
	//
	// int m = 1;
