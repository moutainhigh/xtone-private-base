...
$(function(){
    $("[data-toggle='popover']").popover({
        ...
        content : '<div style="height: 258px;width: 258px;"><img style="height: 258px;width: 258px;" src="images/erweima_vanggame.jpg"/></div>', //this is the content of the html box. add the image here or anything you want really.
        animation: false
