...
public final class CmppeSubmit
{
    ...
    public void  setDestterminalid(byte[][] b)
   ...
   /* protected void printAllField()
    {
        try
        {
            String s = null;
            s = new String(icpId);
            System.out.println("icpId:" + s);
            s = null;
            s = new String(svcType);
            System.out.println("svcType:" + s);
            s = null;
            System.out.println("feeType:" + feeType);
            s = null;
            System.out.println("infoFee:" + infoFee);
            System.out.println("protoId:" + protoId);
            s = null;
            System.out.println("msgMode:" + msgMode);
            ...
            System.out.println("feeUtype:" + feeUtype);
            s = null;
            s = new String(feeUser);
            System.out.println("feeUser:" + s);
            s = null;
            s = new String(srcAddr);
            System.out.println("srcAddr:" + s);
            ...
            for(int i = 0; i < 100; i++)
            {
                if(dstAddr[i][0] == 0)
                    break;
                s = new String(dstAddr[i]);
                System.out.println("dstAddr:" + s);
            }

            System.out.println("dataCoding:" + dataCoding);
            System.out.println("smLen:" + smLen);
            s = null;
            s = new String(shortMsg, "GB2312");
            System.out.println("shortMsg:" + s);
        }
        catch(Exception _ex) { }
    }
*/
