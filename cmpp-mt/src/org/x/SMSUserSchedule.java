...
public class SMSUserSchedule
{
	...
	*/
	 ...
	 ResultSet rs = null;
	 String strSql;
	 public static final int SPCODE_LEN=8; //�����ų���
	 public static final int CORP_LEN=2;//ý��ų���
	 public static final int GAME_LEN=3;//��Ϸ�ų���
	 public static final int GAME_LEN1=2;//��Ϸ����Ϊ2
	 public static final int GAME_LEN2=1;//��Ϸ����Ϊ1
	 public static final int GAME_LEN3=4;//��Ϸ����Ϊ4
	 public static final int GAME_LEN4=5;//��Ϸ����Ϊ5
	...
	*/
	public boolean isItemExist(String strGameCode)
	{
		...
		try
		{
			strSql="select gamename,gameid,vcpid from sms_gamelist where gamename='"+strGameCode+"' and ismgid='"+ismgId+"'";
