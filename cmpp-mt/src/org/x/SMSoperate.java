...
public class SMSoperate
{
	...
	*/
	 ...
	 *
	 */
	 public void setDeliver_ismgID(String _ismgID){this.deliver_ismgID = _ismgID;}
	 public void setDeliver_msgID(String _msgID){this.deliver_msgID = _msgID;}
	 public void setDeliver_spCode(String _spCode){this.deliver_spCode = _spCode;}
	 public void setDeliver_serverID(String _serverID){this.deliver_serverID = _serverID;}
	 public void setDeliver_fmt(int _fmt){this.deliver_fmt = _fmt;}
	 ...
	 public void setDeliver_contentLen(int _len){this.deliver_contentLen = _len;}
	 public void setDeliver_content(byte[] _content){this.deliver_content =_content;}
      ...
      */
      ...
      public void receiveDeliver()
      {
      	try
      	{
    		...
    		user.setUser_cpnType(this.src_CpnType);//�û��ֻ����������뻹��α�롣
    		...
    		//smsmo.setMO_vcpID(smsus.getUSched_vcpID());//������2009-05-05
    		smsmo.setMO_vcpID(0);//((r.nextInt(100)%4));//�����2009-05-05 ���ڽ����з����ڲ�ͬ��ҵ�����н��ն�
