...
public class SMSMT
{
    	...
    	public String destCpn;   //���շ����ֻ���
    	public String feeCpn;    //���ͷ����ֻ���
    	public String serverID;   // ���������Ǹ���Ŀ��
    	public String serverName;
    	public String infoFee;    //���õ�ֵ(�Է�Ϊ��λ)
    	public String feeCode;
    	public String feeType;    // �շѵķ�ʽ
...
//	    	}
			try
			{
				...
				strSql+=",comp_msgid='"+submitMsgID+"'";//���ڱ�ʶ�·�����Ϣ��Id
        	...
        	try 
      	    {
        	    ...
        	    mtSubmitSeq.setMT_submitSeq(this.submitSeq);
        	    mtSubmitSeq.setMT_submitMsgID(this.submitMsgID);
        	    mtSubmitSeq.setMT_submitResult(this.submitResult);
        	    mtSubmitSeq.setMT_ismgID(this.ismgID);
        	    mtSubmitSeq.updateSubmitSeq();
        	    /*
        	    MtsMtHandle mtsMtLog = new MtsMtHandle();
        	    mtsMtLog.setMT_submitSeq(this.submitSeq);
        	    mtsMtLog.setMT_submitMsgID(this.submitMsgID);
        	    mtsMtLog.setMT_submitResult(this.submitResult);
        	    mtsMtLog.setMT_ismgID(this.ismgID);
        	    mtsMtLog.updateSubmitSeq();
        	    */
        	}
        	catch(Exception e)
        	{
