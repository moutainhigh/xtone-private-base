...
public class SMSMOtoVCP
{
   ...
   String vcp_ip1 =(String)ConfigManager.getInstance().getConfigItem("vcp_ip1","vcp_ip1 not found");
   String vcp_port1 =(String)ConfigManager.getInstance().getConfigItem("vcp_port1","vcp_port1 not found");
   String vcp_port2 =(String)ConfigManager.getInstance().getConfigItem("vcp_port2","vcp_port2 not found");
   String vcp_port3 =(String)ConfigManager.getInstance().getConfigItem("vcp_port3","vcp_port2 not found");
   String vcp_port4 =(String)ConfigManager.getInstance().getConfigItem("vcp_port4","vcp_port2 not found");

   
   String vcp_ip2 =(String)ConfigManager.getInstance().getConfigItem("vcp_ip2","vcp_ip2 not found");
   String vcpip2_port2 =(String)ConfigManager.getInstance().getConfigItem("vcpip2_port2","vcp_port2 not found");
	...
	public String send_mosms_to_vcp(SMSMO smsmo)
	{
		...
		try
		{
			...
			switch(vcpID)
			{
				case 0: System.out.println(vcp_ip1);
						xtsms.connect_to_server(vcp_ip1,Integer.parseInt(vcp_port1),xtconn); //连接服务器
						break;
				case 1: System.out.println(vcp_ip1);
				        xtsms.connect_to_server(vcp_ip1,Integer.parseInt(vcp_port2),xtconn); //连接服务器
				        break;
				case 2:  System.out.println(vcp_ip1);
						...
						break;
				case 3:  System.out.println(vcp_ip1);
						xtsms.connect_to_server(vcp_ip1,Integer.parseInt(vcp_port4),xtconn);
						break;
				default: System.out.println(vcp_ip1);
				        xtsms.connect_to_server(vcp_ip1,Integer.parseInt(vcp_port1),xtconn); //连接服务器
				        break;
				/*
				case 1: System.out.println(vcp_ip1);
				        xtsms.connect_to_server(vcp_ip1,Integer.parseInt(vcp_port1),xtconn); //连接服务器
				        break;
				case 2:  System.out.println(vcp_ip2);
						xtsms.connect_to_server(vcp_ip2,Integer.parseInt(vcp_port2),xtconn);
						break;
				default: System.out.println(vcp_ip1);
				        xtsms.connect_to_server(vcp_ip1,Integer.parseInt(vcp_port1),xtconn); //连接服务器
