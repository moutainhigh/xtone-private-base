...
import java.util.*;//添加于09-05-05 用于产生随机数
      ...
      */
      ...
      public void receiveDeliver()
      {
      	try
      	{
    		...
    		//smsmo.setMO_vcpID(smsus.getUSched_vcpID());//屏蔽于2009-05-05
    		smsmo.setMO_vcpID(0);//((r.nextInt(100)%4));//添加于2009-05-05 用于将上行分配于不同的业务上行接收端
